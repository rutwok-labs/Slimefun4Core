...
public class Juicer extends MultiBlockMachine {
    ...
    public Juicer(ItemGroup itemGroup, SlimefunItemStack item) {
        super(itemGroup, item, new ItemStack[] { null, new ItemStack(Material.GLASS), null, null, new ItemStack(Material.NETHER_BRICK_FENCE), null, null, SF4Items.create(Material.DISPENSER, "Dispenser (Facing up)"), null }, BlockFace.SELF);
    }
