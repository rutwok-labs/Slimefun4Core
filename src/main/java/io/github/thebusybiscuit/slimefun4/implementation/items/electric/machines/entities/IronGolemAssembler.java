...
public class IronGolemAssembler extends AbstractEntityAssembler<IronGolem> {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        preset.addItem(1, SF4Items.create(getHead(), "&7Pumpkin Slot", "", "&fThis Slot accepts Pumpkins"), ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(7, SF4Items.create(getBody(), "&7Iron Block Slot", "", "&fThis Slot accepts Iron Blocks"), ChestMenuUtils.getEmptyClickHandler());
