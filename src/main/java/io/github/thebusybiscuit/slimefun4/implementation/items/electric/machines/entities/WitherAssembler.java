...
public class WitherAssembler extends AbstractEntityAssembler<Wither> {
    ...
    protected void constructMenu(BlockMenuPreset preset) {
        preset.addItem(1, SF4Items.create(getHead(), "&7Wither Skeleton Skull Slot", "", "&fThis Slot accepts Wither Skeleton Skulls"), ChestMenuUtils.getEmptyClickHandler());
        preset.addItem(7, SF4Items.create(getBody(), "&7Soul Sand Slot", "", "&fThis Slot accepts Soul Sand"), ChestMenuUtils.getEmptyClickHandler());
