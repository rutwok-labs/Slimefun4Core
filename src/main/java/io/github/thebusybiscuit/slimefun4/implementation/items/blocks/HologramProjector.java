...
public class HologramProjector extends SlimefunItem implements HologramOwner {
    ...
    private void openEditor(@Nonnull Player p, @Nonnull Block projector) {
        ...
        menu.addItem(0, SF4Items.create(Material.NAME_TAG, "&7Text &e(Click to edit)", "", "&f" + SF4Colors.color(BlockStorage.getLocationInfo(projector.getLocation(), "text"))));
        menu.addMenuClickHandler(0, (pl, slot, item, action) -> {
            ...
            ChatUtils.awaitInput(pl, message -> {
                ...
                hologram.setCustomName(SF4Colors.color(message));
        ...
        menu.addItem(1, SF4Items.create(Material.CLOCK, "&7Offset: &e" + NumberUtils.roundDecimalNumber(Double.valueOf(BlockStorage.getLocationInfo(projector.getLocation(), OFFSET_PARAMETER)) + 1.0D), "", "&fLeft Click: &7+0.1", "&fRight Click: &7-0.1"));
